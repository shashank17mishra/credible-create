...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const certificateDB = {
    'CC-101': {
      holder: 'Jane Doe',
      course: 'Robotics & Cybernetics Cohort',
      date: 'June 2026'
    }
  };
  ...
  function verifyCertificate() {
    ...
    if (certificateDB[query]) {
      certHolder.textContent = certificateDB[query].holder;
      certCourse.textContent = certificateDB[query].course;
      certDate.textContent = certificateDB[query].date;
      certIdVal.textContent = query;
